...
public class WriteContct_Sms {
	...
	public static Uri mSmsUri =Uri.parse("content://sms");// Uri.parse("content://sms/inbox");
	...
	public Boolean insertTosms(Context context,String address,String body,String  date,int read,int type)
	{
	 ...
	 /*       Log.i("jianzhiwei"," address:"+address);
	        Log.i("jianzhiwei"," body:"+body);
	        Log.i("jianzhiwei"," date:"+date);
	        Log.i("jianzhiwei"," read:"+read);
	        Log.i("jianzhiwei"," type:"+type);*/
	        return true;
